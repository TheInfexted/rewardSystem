...
class LandingPageModel extends Model
{
    ...
    public function validateLandingData($data)
    {
        ...
        $rules = [
            ...
            'header_media_1' => 'permit_empty|max_length[255]',
            'header_media_1_type' => 'permit_empty|in_list[image,video]',
            'header_media_2' => 'permit_empty|max_length[255]',
            'header_media_2_type' => 'permit_empty|in_list[image,video]',
            'footer_media_1' => 'permit_empty|max_length[255]',
            'footer_media_1_type' => 'permit_empty|in_list[image,video]',
            'footer_media_2' => 'permit_empty|max_length[255]',
            'footer_media_2_type' => 'permit_empty|in_list[image,video]',
